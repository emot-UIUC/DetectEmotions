...
public class CameraView extends FrameLayout implements CameraHelper.OnCameraHelperEventListener {
     ...
     * Notice that CameraHelper notifies us of the physical, pre-rotation width and height of the
     * camera frames, so we need to account for possible rotation in this method.
     */
    @Override
